<div class="container preload">
    <div class="row" style="height: 200px;">
        <div class="col-1 d-none d-sm-none pl-0 ml-0 d-flex justify-content-start mr-4 align-items-center" style="flex-wrap: nowrap; overflow: visible; text-overflow: ellipsis;">
        ...
        <div class="col-1 d-md-none d-lg-none d-md-none d-xl-none pl-0 ml-0 d-flex justify-content-start mr-4 align-items-center" style="flex-wrap: nowrap; line-height: .7">
            <div class="centered-text text-danger" style="transform: rotate(270deg); white-space: nowrap; overflow: visible; text-overflow: ellipsis;">
                pending approval
            </div>
        </div>
            ...
            <div class="creditcard">
                <div class="front">
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svg_card_name" class="st2 st5 st6"><?= $name ?></text>
